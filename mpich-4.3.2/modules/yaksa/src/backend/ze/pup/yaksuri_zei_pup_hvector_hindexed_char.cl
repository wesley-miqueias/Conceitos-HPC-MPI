...
__kernel void yaksuri_zei_kernel_pack_REPLACE_hvector_hindexed_char(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
...
__kernel void yaksuri_zei_kernel_unpack_REPLACE_hvector_hindexed_char(__global const void *inbuf, __global void *outbuf, unsigned long count, __global const yaksuri_zei_md_s *__restrict__ md)
{
    __global const char *__restrict__ sbuf = (__global char *) inbuf;
    __global char *__restrict__ dbuf = (__global char *) outbuf;
