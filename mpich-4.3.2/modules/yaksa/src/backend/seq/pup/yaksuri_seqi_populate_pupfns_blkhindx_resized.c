    ...
    switch (type->u.blkhindx.child->u.resized.child->kind) {
        ...
        switch (type->u.blkhindx.child->u.resized.child->u.builtin.handle) {
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized__Bool";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_char";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_wchar_t";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_int8_t";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_int16_t";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_int32_t";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_int64_t";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_float";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_double";
            }
            break;
            ...
            if (max_nesting_level >= 2) {
                ...
                seq->name = "yaksuri_seqi_op_blkhindx_resized_long_double";
            }
            break;
            case YAKSA_TYPE__C_COMPLEX:
            if (max_nesting_level >= 2) {
                seq->pack = yaksuri_seqi_pack_blkhindx_resized_c_complex;
                seq->unpack = yaksuri_seqi_unpack_blkhindx_resized_c_complex;
                seq->name = "yaksuri_seqi_op_blkhindx_resized_c_complex";
            }
            break;
            case YAKSA_TYPE__C_DOUBLE_COMPLEX:
            if (max_nesting_level >= 2) {
                seq->pack = yaksuri_seqi_pack_blkhindx_resized_c_double_complex;
                seq->unpack = yaksuri_seqi_unpack_blkhindx_resized_c_double_complex;
                seq->name = "yaksuri_seqi_op_blkhindx_resized_c_double_complex";
            }
            break;
            case YAKSA_TYPE__C_LONG_DOUBLE_COMPLEX:
            if (max_nesting_level >= 2) {
                seq->pack = yaksuri_seqi_pack_blkhindx_resized_c_long_double_complex;
                seq->unpack = yaksuri_seqi_unpack_blkhindx_resized_c_long_double_complex;
                seq->name = "yaksuri_seqi_op_blkhindx_resized_c_long_double_complex";
            }
            break;
            default:
                break;
