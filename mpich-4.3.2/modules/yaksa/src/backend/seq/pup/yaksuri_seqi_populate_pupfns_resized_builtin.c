...
int yaksuri_seqi_populate_pupfns_resized_builtin(yaksi_type_s * type)
{
    ...
    switch (type->u.resized.child->u.builtin.handle) {
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized__Bool";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_char";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_wchar_t";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_int8_t";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_int16_t";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_int32_t";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_int64_t";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_float";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_double";
        }
        break;
        ...
        if (max_nesting_level >= 1) {
            ...
            seq->name = "yaksuri_seqi_op_resized_long_double";
        }
        break;
        case YAKSA_TYPE__C_COMPLEX:
        if (max_nesting_level >= 1) {
            seq->pack = yaksuri_seqi_pack_resized_c_complex;
            seq->unpack = yaksuri_seqi_unpack_resized_c_complex;
            seq->name = "yaksuri_seqi_op_resized_c_complex";
        }
        break;
        case YAKSA_TYPE__C_DOUBLE_COMPLEX:
        if (max_nesting_level >= 1) {
            seq->pack = yaksuri_seqi_pack_resized_c_double_complex;
            seq->unpack = yaksuri_seqi_unpack_resized_c_double_complex;
            seq->name = "yaksuri_seqi_op_resized_c_double_complex";
        }
        break;
        case YAKSA_TYPE__C_LONG_DOUBLE_COMPLEX:
        if (max_nesting_level >= 1) {
            seq->pack = yaksuri_seqi_pack_resized_c_long_double_complex;
            seq->unpack = yaksuri_seqi_unpack_resized_c_long_double_complex;
            seq->name = "yaksuri_seqi_op_resized_c_long_double_complex";
        }
        break;
        default:
            break;
