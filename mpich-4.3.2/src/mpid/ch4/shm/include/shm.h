...
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_progress(int vci,
...
MPL_STATIC_INLINE_PREFIX bool MPIDI_SHM_am_check_eager(MPI_Aint am_hdr_sz, MPI_Aint data_sz,
                                                       ...
                                                       MPIR_Request * sreq)
    MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX bool MPIDI_SHM_am_can_do_tag(void) MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_am_tag_send(int rank, MPIR_Comm * comm, int handler_id,
                                                   int tag, const void *buf, MPI_Aint count,
                                                   MPI_Datatype datatype, int src_vci, int dst_vci,
                                                   MPIR_Request * sreq) MPL_STATIC_INLINE_SUFFIX;
MPL_STATIC_INLINE_PREFIX int MPIDI_SHM_am_tag_recv(int rank, MPIR_Comm * comm, int handler_id,
